...
import 'package:shopping4/forgot%20password.dart';
import 'package:shopping4/homepage.dart';
import 'package:shopping4/signup.dart';
          ...
          child: Stack(
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    Center(child: Image.asset('image/shop.jpeg',width: MediaQuery.of(context).size.width/2,fit: BoxFit.cover,)),
                    SizedBox(height: 30,),
                    Material(
